...
export const filmCard = filmData => {
    const { id: filmId, poster_path: posterPath, original_title: originalTitle, overview, genre_ids: genreIds, release_date: releaseDate, vote_average: voteAverage } = filmData;
